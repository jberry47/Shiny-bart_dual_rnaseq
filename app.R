...
sorg_data <- list(
  ...
  mock_ntj2_grassl = read.table("data/cuffdiff/cuffdiff_classicfpkm_dispersionpercondition_dualRNAseq_grassl.mock_ntj2.mock_Sbicolor_454_v3.0.1_xhan_rnaseq1_s.annot_190118/gene_exp.diff",header=T,sep = "\t",stringsAsFactors = F),
